...
module.exports = Application = (function() {
  ...
  Application.prototype._cacheElement = function(index, element) {
    var bootstrap, cacheObject, data, e, html, _ref;
    bootstrap = $(element);
    try {
      html = bootstrap.html();
      ...
      if (cacheObject.usage === 'forever') {
        cacheObject.value = function() {
          return JSON.parse(html);
        };
      }
      return this.cache.set(bootstrap.data('url'), cacheObject);
    } catch (_error) {
      e = _error;
  ...
  Application.prototype._cacheSync = function(options) {
    var cacheKey, data, method, value, _ref;
    if (options == null) {
      options = {};
    }
    ...
    if (method === "get") {
      if ((data = this.cache.get(cacheKey)) !== null) {
        value = _.isFunction(data.value) ? data.value() : data.value;
        _.defer(this._executeCallback, options, value);
        if (data.usage === 'once') {
  ...
  Application.prototype._executeCallback = function(options, value) {
    if (typeof options.success === "function") {
      options.success(value);
    }
    return typeof options.complete === "function" ? options.complete(value) : void 0;
  };
